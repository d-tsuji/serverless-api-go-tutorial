...
//go:generate swagger generate server --target ..\..\gen --name ExampleApp --spec ..\..\swagger.yaml --exclude-main

func configureFlags(api *operations.ExampleAppAPI) {
